...
var ceviriler = {
	...
	"tut_metin_1": {
		"tr": "SPHENKS'e hoş geldin. İşin basit: blokların var, bir masa var ve o masanın diğer tarafında seni bekleyen bir şey var. Blokları satır ve sütunlar halinde dizerek patlat ve puan topla. Ama yerleştirdiğin her blok... beraberinde sonuçlar getirir.",
		"en": "Welcome to SPHENKS. Your job is simple: you have blocks, there's a table, and there's something waiting for you on the other side of that table. Stack the blocks into rows and columns to pop them - and rack up points. But every block you place... has consequences."
	},
	...
	"tut_baslik_5": { "tr": "THE GOLD POUCH", "en": "THE GOLD POUCH" },
	"tut_metin_5": {
		"tr": "Kalçandaki o keseyi görüyor musun? Mevcut Altınını kontrol etmek için [G] tuşuna basılı tut. Burada her şey Altındır - katmanlar arasındaki Markette onu akıllıca harca. Tüccar cömerttir. Tüccar aynı zamanda bir yalancıdır.",
		"en": "See that pouch at your hip? Hold [G] to check your current Gold. Gold is everything here - spend it wisely at the Shop between layers. The Merchant is generous. The Merchant is also a liar."
	},
	"tut_ipucu_5": { "tr": "(Mevcut Altınını görmek için [G] / [Sol Bumper] basılı tut)", "en": "(Hold [G] / [Left Bumper] to check your Gold)" },
	"tut_baslik_6": { "tr": "YOUR WEAPONS", "en": "YOUR WEAPONS" },
	"tut_metin_6": {
		"tr": "Savunmasız değilsin. Revolver'ını çekmek için Sağ Tıkla [Sağ Fare / Sol Tetik]. Kınına koymak için tekrar Sağ Tıkla. Revolver için [1], varsa Shotgun için [2] tuşuna bas. Her silahın mermi sayısını görmek için duvardaki Silah Kutusuna bak.",
		"en": "You are not defenseless. Right-click [Right Mouse / Left Trigger] to draw your Revolver. Right-click again to holster it. Press [1] for the Revolver, [2] for the Shotgun - if you have one. Look at the Gun Box on the wall to see your current ammo count for each weapon."
	},
	"tut_ipucu_6": { "tr": "(Çıkarmak/Kılıfa koymak için Sağ Tık - [1] Revolver - [2] Shotgun)", "en": "(Right-click to draw/holster - [1] Revolver - [2] Shotgun)" },
	"tut_baslik_7": { "tr": "THE TOTEMS", "en": "THE TOTEMS" },
	"tut_metin_7": {
		"tr": "Yanındaki masada duran o küçük figürleri görüyor musun? Onlar Firavun'un totemleri - sahip olduğu her can için bir tane. İsabet ettirdiğin her mermi birini parçalar. Sağlık çubuğuna değil, masaya bak. Son totem düştüğünde, Firavun da düşer.",
		"en": "See those small figures on the table beside you? Those are the Pharaoh's totems - one for each life it has. Every bullet you land shatters one. Watch the table, not a health bar. When the last totem falls, so does the Pharaoh."
	},
	"tut_ipucu_7": { "tr": "(Firavun'u vurarak totemlerini yok et)", "en": "(Shoot the Pharaoh to destroy its totems)" },
	"tut_baslik_8": { "tr": "YOUR OWN LIFE", "en": "YOUR OWN LIFE" },
	"tut_metin_8": {
		"tr": "Sol duvarda asılı duran o kavanozlar mı? O sensin. Dört tanesine sahipsin - her biri 10 HP tutar. Yeterli hasar alırsan bir kavanoz kırılır. Zincirler şıngırdar. Cam patlar. Kan. Dördü de gittiğinde her şey biter. Hepsinin kırılmasına izin verme.",
		"en": "Those jars hanging on the left wall? That's you. You have four of them - each holds 10 HP. Take enough damage and a jar breaks. Chains rattle. Glass shatters. Blood. When all four are gone, it's over. Don't let them all break."
	},
	"tut_ipucu_8": { "tr": "(4 kavanoz x 10 HP = Toplam 40 HP)", "en": "(4 jars x 10 HP = 40 HP total)" },
	"tut_baslik_9": { "tr": "ADIM 4: FİRAVUNUN UYANIŞI", "en": "STEP 4: PHARAOH'S AWAKENING" },
	"tut_metin_9": { "tr": "DİKKAT! Satır patlattıktan sonra blokların çıkarttığı ses firavunu derin uykusundan uyandırır.\n\nUyanan firavun artık HER blok yerleştirmenden sonra sana ölümcül bir saldırı yapacaktır!", "en": "ATTENTION! The sound blocks make after popping a row wakes the pharaoh from his deep sleep.\n\nThe awakened pharaoh will now make a deadly attack on you after EVERY block you place!" },
	"tut_ipucu_9": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_10": { "tr": "ADIM 5: SAVUŞTURMA (BEKLE)", "en": "STEP 5: PARRY (WAIT)" },
	"tut_metin_10": { "tr": "Boss sana saldırmak üzere! Suratını ekranda gördüğün an tepki vermeye hazır ol...\n(Saldırıyı bekle)", "en": "The Boss is about to attack! Be ready to react the moment you see his face on screen...\n(Wait for the attack)" },
	"tut_ipucu_10": { "tr": "(Saldırı bekleniyor...)", "en": "(Waiting for attack...)" },
	"tut_baslik_11": { "tr": "HAZIR OL: PARRY YAP!", "en": "GET READY: PARRY!" },
	"tut_metin_11": { "tr": "Doğru zamanda PARRY (Savuşturma) yaparak boss atağını bloke edebilirsin!", "en": "You can block the boss attack by performing a PARRY at the right time!" },
	"tut_ipucu_11": { "tr": "(SAĞ TIK / [B] tuşuna basarak Savuşturur!)", "en": "(Right-click / [B] to Parry!)" },
	"tut_baslik_12": { "tr": "ADIM 6: HAYALET HAMLE", "en": "STEP 6: GHOST MOVE" },
	"tut_metin_12": {
		"tr": "Mükemmel! Bir saldırıyı başarıyla savuşturduğunda, 5 saniyelik bir 'HAYALET HAMLE' penceresi kazanırsın.\n\nBu 5 saniye içinde masaya yerleştirdiğin bloklar Boss tarafından GÖRÜLMEZ. Sıranı kullanmadan kombo yapabilirsin!",
		"en": "Excellent! When you successfully parry an attack, you gain a 5-second 'GHOST MOVE' window.\n\nDuring these 5 seconds, the blocks you place on the table are INVISIBLE to the Boss. You can combo without using your turn!"
	},
	"tut_ipucu_12": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_13": { "tr": "ADIM 7: HAYALET HAMLEYİ KULLAN", "en": "STEP 7: USE GHOST MOVE" },
	"tut_metin_13": { "tr": "Şimdi hızlı ol! Devam ettiğinde oyun süresi donacak, 5 saniyen var gibi düşünerek hemen bir blok alıp masaya yerleştir!", "en": "Now be quick! The game time will freeze when you continue, think as if you have 5 seconds and immediately take a block and place it on the table!" },
	"tut_ipucu_13": { "tr": "(Süre dondu... Hızlıca bir blok alıp masaya koy)", "en": "(Time frozen... Quickly place a block on the table)" },
	"tut_baslik_14": { "tr": "ADIM 8: AYAĞA KALKMA", "en": "STEP 8: STANDING UP" },
	"tut_metin_14": { "tr": "Masa başından kalkıp odanın geri kalanını keşfetmen gerekecek.\n\nTekrar [E] / [Y] tuşuna basarak masadan kalkıp odada gezebilirsin.", "en": "You'll need to get up from the table and explore the rest of the room.\n\nPress [E] / [Y] again to get up from the table and walk around the room." },
	"tut_ipucu_14": { "tr": "(Masadan kalkmak için [E] / [Y] tuşuna bas)", "en": "(Press [E] / [Y] to get up from the table)" },
	"tut_baslik_15": { "tr": "ADIM 9: ÖZEL EŞYALAR", "en": "STEP 9: SPECIAL ITEMS" },
	"tut_metin_15": {
		"tr": "Bazen Market bir Ruh Mantarı sunar. Onu yan masadan al, yukarı bak ve tüket. Dünya değişecek. Bu bir hata değil. Bu, Mantarın işini yapmasıdır.",
		"en": "Sometimes the Shop offers a Spirit Mushroom. Pick it up from the side table, look up, and consume it. The world will change. This is not a bug. This is the Mushroom working."
	},
	"tut_ipucu_15": { "tr": "(Almak için Sol Tık - Tüketmek için yukarı bakarken tekrar Sol Tık)", "en": "(Left click to take - Left click again while looking up to consume)" },
	"tut_baslik_16": { "tr": "ADIM 10: EFEKTLER GÜZELDİR", "en": "STEP 10: EFFECTS ARE NICE" },
	"tut_metin_16": { "tr": "Vuhu! İşte şimdi ortama biraz renk geldi değil mi!\n\nMasaya dönmek için tekrar tabureye [E] ile otur.", "en": "Woohoo! Now the place has some color, right!\n\nSit on the stool with [E] again to return to the table." },
	"tut_ipucu_16": { "tr": "(Tabureye tekrar otur)", "en": "(Sit on the stool again)" },
	"tut_baslik_17": { "tr": "ADIM 11: RENK KOMBOLARI", "en": "STEP 11: COLOR COMBOS" },
	"tut_metin_17": { "tr": "Aynı renk blokları yan yana patlatmak sana ekstra bölüm içi puan (Altın) kazandırır!\n\nAma şunu unutma; marketten alınan ve kullanılan her nesne SADECE o bölüm için geçerlidir. Sonraki katmanlara taşınmaz!", "en": "Popping blocks of the same color adjacent to each other earns you extra in-level points (Gold)!\n\nBut remember; every item bought from the shop and used is ONLY valid for that level. They don't carry over to next layers!" },
	"tut_ipucu_17": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_18": { "tr": "ADIM 12: KAPIDAN GEÇİŞ", "en": "STEP 12: GOING THROUGH THE DOOR" },
	"tut_metin_18": {
		"tr": "Katman, minimum puana ulaşıldığında VE Firavunla ilgilenildiğinde biter - ölü olduğunda veya onu durduracak mermisi kalmadığında. Firavun hayatta kalırsa kaybolmaz. Bekler. Bir sonraki katmanlarda geri gelir - halihazırda orada olan yeni tehditle birlikte. Açık kapıdan geç. Market SOLDAR, Kamp Ateşi SAĞDA. Seçim senin.",
		"en": "The layer ends when the minimum score is reached AND the Pharaoh is dealt with - dead, or out of bullets to stop it. If the Pharaoh survives, it doesn't disappear. It waits. Next layer, it comes back - alongside whatever new threat is already there. Pass through the open door. Shop is on the LEFT. Campfire on the RIGHT. The choice is yours."
	},
	"tut_ipucu_18": { "tr": "(Eğitimi bitirmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to end tutorial)" },
	"tut_baslik_19": { "tr": "PYRO MODU: MERMİ DİKKATİ", "en": "PYRO MODE: AMMO ATTENTION" },
	"tut_metin_19": { "tr": "Düşmanlar üzerine akın ederken, tabancanla (Revolver) onları yok edebilirsin.\n\nMermine dikkat et! Sınırlı sayıdalar.", "en": "Defeat enemies with your revolver as they swarm towards you.\n\nWatch your ammo! They are limited." },
	"tut_ipucu_19": { "tr": "(Ateş etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to fire)" },
	"tut_baslik_20": { "tr": "PYRO MODU: SAĞLIK YENİLEME", "en": "PYRO MODE: HEALTH REGENERATION" },
	"tut_metin_20": { "tr": "Düşmanlardan düşen et parçaları olacak.\n\nOnları toplayıp [R] / [L1] tuşu ile tüketebilirsin. İşler ters gittiğinde kaybettiğin canını geri doldurmanın tek yolu budur!", "en": "There will be pieces of meat dropped from enemies.\n\nYou can collect and consume them with [R] / [L1]. This is the only way to refill lost health when things go wrong!" },
	"tut_ipucu_20": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_21": { "tr": "MARKET: GÜÇLENME ZAMANI", "en": "MARKET: TIME TO GET STRONGER" },
	"tut_metin_21": { "tr": "Markete hoş geldin! Burada kazandığın altınlarla sana avantaj sağlayacak çeşitli eşyalar ve tılsımlar alabilirsin.\n\nUnutma, her eşyanın kendine has bir özelliği var ve sadece o bölüm için geçerlidir!", "en": "Welcome to the market! Here you can buy various items and charms that will give you an advantage using the gold you've earned.\n\nRemember, each item has its own unique feature and is only valid for that level!" },
	"tut_ipucu_21": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_22": { "tr": "MARKET: EŞYA SATIN ALMA", "en": "MARKET: BUYING ITEMS" },
	"tut_metin_22": { "tr": "Bir eşyanın üzerine gelince fiyatını ve açıklamasını görebilirsin. Satın almak için üzerine tıkla.\n\nEnvanterin sınırlıdır, bu yüzden seçimlerini stratejik yap!", "en": "You can see the price and description of an item when you hover over it. Click on it to buy.\n\nYour inventory is limited, so make your choices strategically!" },
	"tut_ipucu_22": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_23": { "tr": "KAMP ATEŞİ: DİNLENME VE ŞANS", "en": "CAMPFIRE: REST AND LUCK" },
	"tut_metin_23": { "tr": "Kamp ateşine vardığında sana iki seçenek sunulur: DİNLENME veya ALTIN ARAMA.\n\nDİNLENME (+1 Can Barı) sağlar, ALTIN ARAMA ise sana rastgele miktarda altın verir. İhtiyacına göre kararını ver!", "en": "When you reach the campfire, you are presented with two choices: REST or SEARCH FOR GOLD.\n\nREST grants (+1 Health Bar), while SEARCH FOR GOLD gives you a random amount of gold. Decide according to your needs!" },
	"tut_ipucu_23": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_24": { "tr": "KAMP ATEŞİ: KART SEÇİMİ", "en": "CAMPFIRE: CARD SELECTION" },
	"tut_metin_24": { "tr": "Karşındaki kartlardan birine tıklayarak seçimini yapabilirsin. Seçimini yaptıktan sonra kapı açılır ve yoluna devam edebilirsin.", "en": "You can make your choice by clicking on one of the cards in front of you. Once you make your choice, the door will open and you can continue on your way." },
	"tut_ipucu_24": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
