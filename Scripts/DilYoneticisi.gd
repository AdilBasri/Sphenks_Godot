...
var ceviriler = {
	...
	"tut_baslik_17": { "tr": "MARKET: GÜÇLENME ZAMANI", "en": "MARKET: TIME TO GET STRONGER" },
	"tut_metin_17": { "tr": "Markete hoş geldin! Burada kazandığın altınlarla sana avantaj sağlayacak çeşitli eşyalar ve tılsımlar alabilirsin.\n\nUnutma, her eşyanın kendine has bir özelliği var ve sadece o bölüm için geçerlidir!", "en": "Welcome to the market! Here you can buy various items and charms that will give you an advantage using the gold you've earned.\n\nRemember, each item has its own unique feature and is only valid for that level!" },
	"tut_ipucu_17": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_18": { "tr": "MARKET: EŞYA SATIN ALMA", "en": "MARKET: BUYING ITEMS" },
	"tut_metin_18": { "tr": "Bir eşyanın üzerine gelince fiyatını ve açıklamasını görebilirsin. Satın almak için üzerine tıkla.\n\nEnvanterin sınırlıdır, bu yüzden seçimlerini stratejik yap!", "en": "You can see the price and description of an item when you hover over it. Click on it to buy.\n\nYour inventory is limited, so make your choices strategically!" },
	"tut_ipucu_18": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_19": { "tr": "KAMP ATEŞİ: DİNLENME VE ŞANS", "en": "CAMPFIRE: REST AND LUCK" },
	"tut_metin_19": { "tr": "Kamp ateşine vardığında sana iki seçenek sunulur: DİNLENME veya ALTIN ARAMA.\n\nDİNLENME (+1 Can Barı) sağlar, ALTIN ARAMA ise sana rastgele miktarda altın verir. İhtiyacına göre kararını ver!", "en": "When you reach the campfire, you are presented with two choices: REST or SEARCH FOR GOLD.\n\nREST grants (+1 Health Bar), while SEARCH FOR GOLD gives you a random amount of gold. Decide according to your needs!" },
	"tut_ipucu_19": { "tr": "(Devam etmek için [SOL TIK] / [A] tuşuna bas)", "en": "(Press [LEFT CLICK] / [A] to continue)" },
	"tut_baslik_20": { "tr": "KAMP ATEŞİ: KART SEÇİMİ", "en": "CAMPFIRE: CARD SELECTION" },
	"tut_metin_20": { "tr": "Karşındaki kartlardan birine tıklayarak seçimini yapabilirsin. Seçimini yaptıktan sonra kapı açılır ve yoluna devam edebilirsin.", "en": "You can make your choice by clicking on one of the cards in front of you. Once you make your choice, the door will open and you can continue on your way." },
